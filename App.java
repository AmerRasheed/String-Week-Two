...
//Correct the following String: "Java is the worst programming language!" by replacing the (obviously incorrect) word "worst" with the word "best". Then print out the sentence.
        ...
        String stringarray[] = st4.split(" ");                          //split function separates the string w.r.t. spaces in st4
...
//Parse the following int: 20 to a String and add a 20 to the end of the String. Printing it out should return: "2020"
        ...
        String words[] = st9.split(" ");                             //split function separates the string w.r.t. spaces in st4
        String splitarray[] = new String[3];
        for(int i=0;i<words.length;i++)                              // Printing array contents :: Oil and Water
            System.out.print(words[i] + " ");

        for(int i=0;i<words.length;i++){
                  if (words[i].equalsIgnoreCase("and"))
                    splitarray[i] = "";                              // condition separating Oil and water
                  else                                               //and storing in separate String array
...
// Convert the following String: "ThisShouldBeConverted" to a char array. Iterate through the char array and print out each element
        ...
        char[] chararray    = new char[st6.length()]; // declaring a char array of length equivalent to string

        for(int i=0;i<chararray.length;i++)
            chararray[i]=st6.charAt(i);               // assigns each element in the string at i position to equivalent position in chararray

        for(int i=0;i<chararray.length;i++)
            System.out.print(chararray[i] + " ");
        System.out.println("\n");

// Another way is by using function toChararray          chararray=st6.toCharArray();


//Convert the following char[]: {'J','a','v','a'} to a String and print it out.
        char[] javacharArray = {'J','a','v','a'};
        System.out.println(Arrays.toString(javacharArray));   //Arrays utility function toString converts char array to String
